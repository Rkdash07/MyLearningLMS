...
function SignInPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Sign in error:', err); // For debugging
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleOAuth = (provider) => {
    // OAuth functionality - can be connected to backend OAuth routes
    ...
    <div className="auth-shell">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">
          Sign in to continue learning securely on MyLearning LMS.
        </p>
